        ...
        <div>
            <div class="col-1 collapse show d-md-flex bg-light pt-1 pl-0 min-vh-100" id="sidebar" style=" position: fixed; height: auto; margin-left: -10px;">
                <ul class="nav flex-column flex-nowrap overflow-hidden">
                    ...
                    <li class="nav-item"><a class="nav-link text-truncate" href="#" style="color: #79C5B4 !important"><i class="fas fa-industry"></i> <span class="d-none d-sm-inline">Mi Empresa</span></a></li>
