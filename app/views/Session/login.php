...
<div class="position-relative" style="margin-right: 30%; margin-left:30%; margin-top:10%; padding: 3%;">
    <form action="<?php echo URLROOT; ?>Session/startSession" method="post">
        ...
        <p style="padding:5px;"><i class="fas fa-laptop-code"></i> <span style="font-size: 10px;">Versión: 2.1 -
                JMGA</span> </p>
    </form>
